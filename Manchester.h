...
#define DEMOD_OUT_1      30  // (PB22) this is the target pin for the raw RFID data from RF circuit 1
//#define DEMOD_OUT_2      42  // (PB23) this is the target pin for the raw RFID data from RF circuit 2
#define SHD_PINA         8  // (PB16) Setting this pin high activates RFID circuit 1 
#define SHD_PINB         9  // (PB17) Setting this pin high activates RFID circuit 2 
